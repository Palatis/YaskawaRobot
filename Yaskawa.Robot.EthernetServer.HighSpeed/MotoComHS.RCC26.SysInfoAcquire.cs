...
namespace Yaskawa.Robot.EthernetServer.HighSpeed
{
    partial class MotoComHS
    {
        ...
        public int ReadSystemInfoData(ushort number, ref SystemInfo info, out ushort err_code)
        {
            ...
            if (ans.status == ERROR_SUCCESS)
            {
                ...
                info.ModelNameOrApp = Encoding.ASCII.GetString(ans.data.Skip(24).Take(16).ToArray());
    ...
    public class SystemInfo
    {
        ...
        /// 名稱/應用
        /// </summary>
        public string ModelNameOrApp = string.Empty;
        ...
        public override string ToString()
        {
            return $"System software version: {SysSoftwareVer},\r\n" +
                $"Model name / application: {ModelNameOrApp},\r\n" +
